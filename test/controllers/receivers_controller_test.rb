...
class ReceiversControllerTest < ActionController::TestCase
  ...
  test "should create receiver" do
    assert_difference('Receiver.count') do
      post :create, receiver: { activation: @receiver.activation, name: @receiver.name, number: @receiver.number }
    end
  ...
  test "should update receiver" do
    patch :update, id: @receiver, receiver: { activation: @receiver.activation, name: @receiver.name, number: @receiver.number }
    assert_redirected_to receiver_path(assigns(:receiver))
  end
